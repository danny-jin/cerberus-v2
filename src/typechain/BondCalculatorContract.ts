...
export interface BondCalculatorContractInterface extends ethers.utils.Interface {
  functions: {
...
export interface BondCalculatorContract extends BaseContract {
  ...
  interface: BondCalculatorContractInterface;
