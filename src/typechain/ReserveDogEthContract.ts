...
export interface ReserveDogEthContractInterface extends ethers.utils.Interface {
  functions: {
...
export type BurnEvent = TypedEvent<[string, BigNumber, BigNumber, string],
  { sender: string; amount0: BigNumber; amount1: BigNumber; to: string }>;

export type BurnEventFilter = TypedEventFilter<BurnEvent>;

export type MintEvent = TypedEvent<[string, BigNumber, BigNumber],
  { sender: string; amount0: BigNumber; amount1: BigNumber }>;

export type MintEventFilter = TypedEventFilter<MintEvent>;

export type SwapEvent = TypedEvent<[string, BigNumber, BigNumber, BigNumber, BigNumber, string],
  {
    sender: string;
    amount0In: BigNumber;
    amount1In: BigNumber;
...
export type SyncEvent = TypedEvent<[BigNumber, BigNumber],
...
export interface ReserveDogEthContract extends BaseContract {
  ...
  interface: ReserveDogEthContractInterface;
