...
export interface BondDogEthContractInterface extends ethers.utils.Interface {
  functions: {
...
export interface BondDogEthContract extends BaseContract {
  ...
  interface: BondDogEthContractInterface;
