...
export interface ShibBondContractInterface extends ethers.utils.Interface {
  functions: {
...
export interface ShibBondContract extends BaseContract {
  ...
  interface: ShibBondContractInterface;
