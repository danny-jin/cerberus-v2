...
import type { ChainLinkAggregatorContract, ChainLinkAggregatorContractInterface } from '../ChainLinkAggregatorContract';
...
export class ChainLinkAggregatorContract__factory {
  static readonly abi = _abi;

  static createInterface(): ChainLinkAggregatorContractInterface {
    return new utils.Interface(_abi) as ChainLinkAggregatorContractInterface;
  }

  static connect(address: string, signerOrProvider: Signer | Provider): ChainLinkAggregatorContract {
    return new Contract(address, _abi, signerOrProvider) as ChainLinkAggregatorContract;
  }
}
